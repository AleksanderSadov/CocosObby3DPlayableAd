...
1. Нет звуков в playable - звуки прыжка и музыки добавил, но в билде playabale при добавлении звуков пока ошибка и не успел разобраться. В обычном веб билде звуки будут работать. Но перед билдом playable в AudioManager нужно убрать ссылки на звуки
