...
1. В обычном веб билде звуки и картинки есть. В инлайненом playable билде звуков и картинок нет, проблема с загрузкой заинлайненных ресурсов - пока не подправил
...
1. Отображение имени параметров в функции при вызове: TypeScript -> Inlay Hints -> Parameter Names
