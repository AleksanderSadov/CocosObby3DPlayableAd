...
1. Свободное движение камеры - начал с не самого подходящего примера CharacterController с фиксированной камерой, потом нашел более подходящий EasyController, но пока не успел внедрить
