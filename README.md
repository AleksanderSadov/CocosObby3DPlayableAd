...
1. Нет свободного движение камеры - начал с не самого подходящего примера CharacterController с фиксированной камерой, потом нашел более подходящий EasyController, но пока не успел внедрить
1. Нет звуков в билде playable - звуки прыжка и музыки добавил, но в билде playabale при добавлении звуков пока ошибка и не успел разобраться. В обычном веб билде звуки будут работать. Но перед билдом playable в AudioManager нужно убрать ссылки на звуки
1. Нет ботов - не успел
...
1. В кокосе из коробки нет билда именно под playable, но нашел подходящий готовый билдер https://store.cocos.com/app/en/detail/3754, в сторе платный но это пожеланию и автор бесплатно выложил на гитхаб: https://github.com/minzhi3/playable-build-tool
    ...
    1. Ошибка при запуске игры если включить звуковые файлы в playable билд
...
1. Сейчас не было времени в точности вести учет, пока приведу примерный расклад:
    ...
    1. Пустой 3D билд со всеми выключенными фичами кроме WebGL весит 1,252Мб
    1. Пустой проект с базовыми 2D UI и 3D и физикой Bullet 3.5Мб, а с физикой cannon 2Мб. Значит следующий шаг если и уменьшать то переходить на физику cannon, но пока не могу отказаться от Bullet из за использования CharacterController
    1. У меня в главной сцене 3.8Мб
