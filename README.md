...
1. Нет звуков - звуки прыжка и музыки добавил, но в билде playabale при добавлении звуков пока ошибка и не успел разобраться. В обычном веб билде звуки могут работать если вернуть ссылки в сцене на звуки, ссылки пока по умолчанию убрал чтобы не ломать playable билд
